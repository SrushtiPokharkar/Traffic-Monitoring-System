  ...
  <div id="sru">
      ...
      <span style="color:black">
        ...
        <form enctype="multipart/form-data" action="PersonalDocumentJava" method="post">
                ...
                <input type="text" name="adharno" placeholder="Adhar Card No"><br><br>
                
                Aadhaar Card Pic : <input type="file" class="button" name="adharpic"><br><br>
                
                <input type="text" name="voteridno" placeholder="Voter Id No"><br><br>
                
                Voter ID Pic : <input type="file" class="button" name="voteridpic"><br><br>
                
                <input type="text" name="panno" placeholder="PAN Card No"><br><br>
                
                PAN Card Pic : <input type="file" class="button" name="panpic"><br><br>
                
                <input type="text" name="drivinglicenceno" placeholder="Driving Licence No"><br><br>
                
                Driving License Pic : <input type="file" class="button" name="drivinglicencepic"><br><br>
                
                
                Driving License  Pic : <input type="date"  name="drivinglicenceupto"><br><br>
