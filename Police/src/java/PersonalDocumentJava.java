...
public class PersonalDocumentJava extends HttpServlet {
...
//                query to insert name and image name
                ...
                pst.setString(2,adharno );
                pst.setString(4,"false");
                pst.setString(5,voteridno);
                pst.setString(7,"false" );
                pst.setString(8,panno );
                pst.setString(10,"false" );
                pst.setString(11,drivinglicenceno );
                pst.setString(13,"false" );
                pst.setString(14,drivinglicenceupto );
